 ...
 <script>
    ...
    $(document).ready(function(){
        ...
        $('#addEnterpriseForm').submit(function(event) {
            ...
            $.ajax({
                ...
                error: function(xhr, status, error) {
                    console.error('Error adding new enterprise:', error);
                }
            });
        });
                ...
                <div class="table-wrapper">
                    <div class="table-title">
                        <div class="row">
                            ...
                            <div class="col-xs-6">
                                <a href="#addEnterpriseModal" class="btn btn-success" data-toggle="modal"><i class="material-icons">&#xE147;</i> <span>Add New Enterprise</span></a>
                                <a href="#deleteEnterpriseModal" class="btn btn-danger" data-toggle="modal"><i class="material-icons">&#xE15C;</i> <span>Delete</span></a>						
                            </div>
                        </div>
                    </div>
                    <table class="table table-striped table-hover">
                        <thead>
                            <tr>
                                ...
                                <th>Ubicación</th>
                                <th>Teléfono</th>
                                <th>Acciones</th> <!-- Cambio de "Actions" a "Acciones" -->
                            </tr>
                        </thead>
        ...
        <!-- Add Enterprise Modal HTML -->
<!-- Add Enterprise Modal HTML -->
<div id="addEnterpriseModal" class="modal fade">
    <div class="modal-dialog">
        <div class="modal-content">
            <form id="addEnterpriseForm">
                <div class="modal-header">						
                    <h4 class="modal-title">Agregar Empresa</h4> <!-- Cambio de "Add Enterprise" a "Agregar Empresa" -->
                ...
                <div class="modal-content">
                    <form id="deleteEnterpriseForm">
                        ...
                        <div class="modal-footer">
                            ...
                            <!-- Cambia el tipo de botón de "submit" a "button" y agrega el evento onclick -->
                            <button type="button" class="btn btn-danger" data-dismiss="modal" onclick="deleteSelectedEnterprises()">Delete</button>
                        </div>
                    </form>
                </div>
            </div>
